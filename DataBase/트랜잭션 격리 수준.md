...
<br>
![alt text](https://miro.medium.com/max/475/1*hEpucQJzGE6K7D9M_0bEVw.gif)
...
- UPDATE 부정합, Phantom Read가 발생 가능
...
- Oracle : 다중 버전 읽기 일관성 모델을 채택하여 lock을 사용하지 않고 Dirty Read를 피해 일관성 있는 데이터 읽기가 가능하게 하게 함
- 
